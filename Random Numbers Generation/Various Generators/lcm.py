...
def linearCongruentialMethod(Xo, m, a, c, lis, noOfRandomNums): 
...
#Xo = random.randrange(100, 874, 79)
#m = random.randrange(90, 200, 54)
#a = random.randrange(19, 100, 2)
#c = random.randrange(5, 50, 10)
Xo = 1 
m = 64
a = 1
c = 1
...
noOflis = 200
lis = [0] * (noOflis) 
linearCongruentialMethod(Xo, m, a, c, lis, noOflis) 
